...
def build_document() -> None:
    ...
    add_callout(document, "Resultado verificable", "La batería automatizada contiene 16 pruebas con 63 aserciones. La aplicación también fue ejecutada contra MariaDB de XAMPP y revisada visualmente en escritorio y móvil.")
    ...
    rubric = [
        ...
        (23, "Pruebas unitarias", "16 pruebas, 63 aserciones."),
