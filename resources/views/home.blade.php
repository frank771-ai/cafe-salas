...
@section('content')
    {{-- Presentación principal y llamadas a la acción. --}}
    <section class="hero">
        <div class="container">
    ...
    <section class="section-space" id="categorias">
        <div class="container">
            <div class="section-heading">
                <div><span class="eyebrow">Encuentre su ritual</span><h2>Categorías</h2></div>
                <a href="{{ route('products.index') }}">Ver todo →</a>
            </div>
            <div class="row g-4">
    ...
    <section class="section-space bg-warm">
        <div class="container">
            <div class="section-heading">
                <div><span class="eyebrow">Selección de la casa</span><h2>Productos destacados</h2></div>
            </div>
            <div class="row g-4">
    ...
    @if ($recent->isNotEmpty())
        <section class="section-space" aria-labelledby="recientes-title">
            <div class="container">
                <div class="section-heading">
                    <div><span class="eyebrow">Guardados mediante cookie</span><h2 id="recientes-title">Vistos recientemente</h2></div>
                </div>
                <div class="row g-4">
