...
<article class="product-card card h-100 border-0" data-tilt-card>
    <a href="{{ route('products.show', $product) }}" class="product-image-wrap">
        ...
        @endif
        <span class="product-view-cue" aria-hidden="true">Ver detalle &rarr;</span>
    </a>
    <div class="card-body d-flex flex-column">
        <div class="product-meta">
            <span>{{ $product->category->name }}</span>
            <span class="product-availability"><i aria-hidden="true"></i>{{ $product->stock > 0 ? 'Disponible' : 'Agotado' }}</span>
        </div>
